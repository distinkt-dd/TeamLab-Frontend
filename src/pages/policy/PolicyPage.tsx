          ...
          <section className={styles.section}>
            ...
            <div className={styles.content}>
              <p>
                ...
                предпринимаемые Ильина Ксения Екатериновна (далее — Оператор).
              </p>
              <p>
              ...
              <p>
                ...
                веб-сайта <a href="https://ssylka.ru/">https://ssylka.ru</a>.
              </p>
            </div>
          </section>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.content}>
              ...
              <p>
                ...
                <a href="https://ssylka.ru/">https://ssylka.ru</a>.
              </p>
              <p>
              ...
              <p>
                ...
                персональных данных (далее — персональные данные, разрешённые
                для распространения).
              </p>
              <p>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.content}>
              ...
              <p>
                ...
                порядок её получения установлен Законом о персональных данных;
              </p>
              <p>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.content}>
              <p>
                ...
                полном объёме требований действующего законодательства в области
              ...
              <p>
                ...
                Оператора <a href="mailto:xxxxxx@mail.ru">xxxxxx@mail.ru</a> с
              ...
              <p>
                ...
                <a href="mailto:xxxxxx@mail.ru">xxxxxx@mail.ru</a> с пометкой
                «Отзыв согласия на обработку персональных данных».
              </p>
              <p>
                8.5. Вся информация, которая собирается сторонними сервисами, в
                том числе платёжными системами, средствами связи и другими
                ...
                Пользователь обязан самостоятельно ознакомиться с указанными
                документами. Оператор не несёт ответственность за действия
              ...
              <p>
                ...
                иных публичных интересах, определённых законодательством РФ.
              </p>
              <p>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.content}>
              <p>
                ...
                данных о своём намерении осуществлять трансграничную передачу
          ...
          <section className={styles.section}>
            ...
            <div className={styles.content}>
              <p>
                ...
                <a href="mailto:xxxxxx@mail.ru">xxxxxx@mail.ru</a>.
              </p>
              <p>
              ...
              <p>
                ...
                <a href="https://shugarandsalt.tilda.ws/privacy">
                  https://shugarandsalt.tilda.ws/privacy
                </a>
                .
              </p>
            </div>
